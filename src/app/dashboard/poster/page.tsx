  ...
  if (isLocked) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center animate-entrance relative z-10">
        ...
        <h1 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-amber-300 mb-4 drop-shadow-md pb-1">Pengumpulan Poster Belum Dibuka</h1>
        <p className="text-white/80 max-w-lg text-lg leading-relaxed font-medium drop-shadow-sm">
          Masa pengumpulan poster adalah <strong className="text-white">1 September - 14 September 2026</strong>. Silakan kembali pada rentang waktu tersebut.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-entrance relative z-10">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-amber-300 drop-shadow-md pb-1">Pengumpulan Poster</h1>
      </div>
      ...
      {!submitted ? (
        <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[1.5rem] p-8 shadow-[0_10px_30px_rgba(0,0,0,0.1)] space-y-6">
          ...
          <div className="bg-pink-500/20 text-pink-100 p-4 rounded-[1.2rem] text-sm mb-6 border border-pink-400/50 shadow-inner backdrop-blur-md leading-relaxed">
            Tim <strong className="text-white">{user.teamName}</strong>, pastikan resolusi gambar poster tinggi agar tidak pecah saat dinilai.
          </div>

          <div className="w-full flex flex-col gap-1.5">
            <label className="text-sm font-bold text-white drop-shadow-sm">Pilih Subtema Poster <span className="text-red-500">*</span></label>
            <select 
          ...
          <Input label="Judul Poster" placeholder="Ketik judul poster karya Anda" variant="glass" required />

          <div className="pt-4">
            <label className="text-sm font-bold text-white mb-2 block drop-shadow-sm">Upload Desain Poster <span className="text-red-500">*</span></label>
            <div className="border border-dashed border-white/30 bg-white/5 rounded-[1.5rem] p-10 text-center hover:bg-white/10 transition-colors cursor-pointer group shadow-sm backdrop-blur-sm">
              ...
              <p className="text-lg font-bold text-white">Klik atau drag gambar ke sini</p>
              <p className="text-sm text-white/70 mt-2 font-medium">Maks. 10MB (Format: .jpg, .png)</p>
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[2rem] p-12 text-center shadow-[0_20px_50px_rgba(0,0,0,0.2)] relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-300 mb-4 drop-shadow-md pb-1">Poster Berhasil Diunggah!</h2>

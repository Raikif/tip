...
export default function CompetitionSection() {
  return (
    <section id="competition" className="panel panel-hidden bg-competition items-center justify-center">
      <div className="max-w-6xl mx-auto px-6 w-full flex flex-col justify-center h-full pt-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 w-full">
          {/* Mahasiswa Card */}
          <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-white flex flex-col items-start transition-transform hover:-translate-y-2 relative overflow-hidden">
